...
export default function Login() {
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#9191e1] px-4 overflow-hidden relative">
        ...
        <div className="w-full max-w-md p-8 bg-[rgba(15,15,35,0.7)] backdrop-blur-xl rounded-2xl border border-[rgba(255,255,255,0.15)] shadow-2xl z-10 transition-all duration-500 hover:border-[rgba(255,255,255,0.25)] hover:shadow-[0_0_30px_rgba(230,230,250,0.15)]">
          <h2 className="text-2xl font-bold mb-6 text-center text-[#e6e6fa] bg-clip-text text-transparent bg-gradient-to-r from-[#e6e6fa] to-[#b0c4de]">Login to your account</h2>
          {errorMessage && (
  ...
  Don&rsquo;t forget your password{' '}
